...
class VideoClipsToolbar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      container: true,
      label: 'Video clips toolbar',
      child: Column(
        children: [
          Semantics(
            textField: true,
            label: 'Search clips by event, camera or date',
            child: Container(
          ...
          Semantics(
            label: 'Date range, ${VideoClipsProvider.dateRangeLabel}',
            child: Row(
              children: [
                ...
                Semantics(
                  button: true,
                  label: 'Sort clips, currently ${activeSort.label}',
