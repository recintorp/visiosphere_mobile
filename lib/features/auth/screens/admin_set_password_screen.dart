...
class AdminSetPasswordScreen extends StatefulWidget {
  const AdminSetPasswordScreen({super.key});

  @override
  State<AdminSetPasswordScreen> createState() => _AdminSetPasswordScreenState();
}

class _AdminSetPasswordScreenState extends State<AdminSetPasswordScreen> {
  ...
  // Show success dialog
  void _showSuccessDialog(BuildContext context, AdminAuthProvider authProvider) {
    showDialog(
      context: context,
          ...
          actions: [
            TextButton(
              onPressed: () {
                ...
                // IMPORTANT: Ensure this matches your actual GoRouter path for the admin login!
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: AppColors.adminColor, // Themed for Admin
        elevation: 0,
      ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Admin ID: ${authProvider.adminId ?? "Unknown"}',
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: AppColors.adminColor),
                    ),
                    child: Text(
                      'This is your first login. Please set a secure password that you will use to access the Facility Dashboard.',
                      style: TextStyle(
                        fontSize: 14,
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIconColor: AppColors.adminColor,
                    ...
                    child: OutlinedButton(
                      onPressed: !authProvider.isLoading
                          ? () {
                              ...
                              authProvider.logout(); 
                              context.go('/admin-login'); // Update to match your actual admin login route
                            }
                          : null,
