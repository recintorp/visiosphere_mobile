...
class _NurseMainWrapperState extends State<NurseMainWrapper> {
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          if (settingsProvider.enableSidebarToggle && authProvider.userRole == 'Facility Admin') ...[
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 24.0, vertical: 8.0),
              child: Container(
                padding: const EdgeInsets.all(4),
                decoration: BoxDecoration(
                  color: isDark ? Colors.white.withValues(alpha: 0.05) : Colors.white.withValues(alpha: 0.15),
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.medical_services_rounded, color: isDark ? const Color(0xFF38BDF8) : const Color(0xFF0FB2EA), size: 16),
                          const SizedBox(width: 6),
                          Text('Nurse', style: TextStyle(color: isDark ? const Color(0xFF38BDF8) : const Color(0xFF0FB2EA), fontWeight: FontWeight.bold, fontSize: 13)),
                        ],
                      ),
                    ),
                  ],
  ...
  Widget _buildDrawerSubItem(IconData icon, String title, {bool isSelected = false, required bool isDark, VoidCallback? onTap}) {
    return Padding(
          ...
          child: AnimatedContainer(
            ...
            child: Row(
              children: [
                Icon(
                  icon, 
                  color: isSelected ? (isDark ? const Color(0xFF38BDF8) : const Color(0xFF0FB2EA)) : Colors.white70, 
                  size: 18
                ),
  ...
  Widget _buildBackgroundLayer(Size size, bool isDark) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: isDark ? Colors.white.withValues(alpha: 0.05) : Colors.white.withValues(alpha: 0.35),
