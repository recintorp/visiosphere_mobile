...
import '../admin/admin_elders_screen.dart';
import '../admin/admin_guardians_screen.dart';
import '../admin/admin_assessments_screen.dart';
...
class _NurseMainWrapperState extends State<NurseMainWrapper> {
  ...
  Widget _getScreenForIndex(int index) {
    switch (index) {
      case 0:
        return AdminHomeScreen(key: const ValueKey(0), onMenuTap: toggleMenu, isNurseView: true);
      case 1:
        return AdminEldersScreen(key: const ValueKey(1), onMenuTap: toggleMenu, isNurseView: true);
      case 2:
        return AdminGuardiansScreen(key: const ValueKey(2), onMenuTap: toggleMenu, isNurseView: true);
      case 3:
      ...
      child: Column(
        ...
        children: [
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: const Icon(Icons.admin_panel_settings, color: Colors.white70, size: 16),
                      ),
                    ),
                    Container(
                      ...
                      child: const Row(
                        children: [
                          Icon(Icons.medical_services, color: Color(0xFF0FB2EA), size: 14),
                          SizedBox(width: 6),
                          Text('Nurse', style: TextStyle(color: Color(0xFF0FB2EA), fontWeight: FontWeight.bold, fontSize: 12)),
                        ],
                      ),
                    ),
                  ],
          ...
          Theme(
            ...
            child: ExpansionTile(
              initiallyExpanded: _currentIndex >= 1 && _currentIndex <= 2,
